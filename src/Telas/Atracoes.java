...
public class Atracoes extends Tela implements ActionListener {
    ...
    public Atracoes( int width, int height ){
        super( width, height);
    }

    public Atracoes( int width, int height, Janela jan ){
        super( width, height, jan );
    }

    public Atracoes( int width, int height, Janela jan, Parque parque ){
        super( width, height, jan );
        this.parque = parque;
        this.start();
    }
