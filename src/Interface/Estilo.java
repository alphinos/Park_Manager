...
public class Estilo {
    ...
    public final static Color verdao = new Color( 0, 168, 59  );
    public final static Color verdinho = new Color( 0, 245, 85  );
    ...
    public final static Font robotoButton = new Font( "roboto" , Font.BOLD, 36);
}
